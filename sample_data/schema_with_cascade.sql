...
ALTER TABLE ONLY public.map
    ADD CONSTRAINT fk_state_id FOREIGN KEY (state_id) REFERENCES public.game_state(id) ON DELETE CASCADE;

ALTER TABLE ONLY public.cell
    ADD CONSTRAINT fk_map_id FOREIGN KEY (map_id) REFERENCES public.map(id) ON DELETE CASCADE,
    ADD CONSTRAINT fk_enemy_id FOREIGN KEY (enemy_id) REFERENCES public.enemy(id) ON DELETE CASCADE,
